            ...
            <ul>
                ...
                <li class="active">
                	<router-link to='/everyonethin'>  
	                    <img src="../assets/images/tabbar/recipe_b.png" alt="">
	                    <p>人人瘦</p>
                     </router-link>
                </li>
                <li>
    ...
    methods:{
    	...
    	getInfoList(){
    		let _this=this;
        		_this.$axios({
		    		method:'POST',
		    		url:_this.$host+'/index.php/Home/Homeapi/rengoods',
		    		params:{
		    			user_id:sessionStorage.getItem('user_id')		    			
		    		}
		    	}).then((res)=>{
		    		console.log(res.data)
		    		_this.renList=res.data.goods;
					_this.actimg=res.data.actimg;
					let temp = document.createElement('div')
	    			temp.innerHTML = res.data.actimg
	    			
	    			_this.actimg = temp.innerText
		    	})
    	},
    	setSelect1(item){
     	let _this=this;
